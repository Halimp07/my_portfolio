    ...
    <Layouts>
      <section className="relative flex w-full flex-col items-center justify-evenly py-40 md:h-screen md:flex-row md:overflow-hidden">
        ...
        <motion.div {...ContentAnimation} className="relative order-1 w-1/3 md:order-2">
          ...
          <h1 className="-ml-1 mb-1 text-7xl font-bold text-primary-light">Halim</h1>
          <h4 className="text-sm font-light transition-all duration-500 hover:text-primary-light">Front-end Dev | UI/UX</h4>
        </motion.div>
      </section>
    </Layouts>
  );
